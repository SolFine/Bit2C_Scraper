...
# Input: the script (as seen above) table and the line number of the buy.
# Output: A list [ rate [NIS/BTC], quantiyty [BTC], total [NIS] ].

def buy_line_values(script, line_num): 

# Indexes for the script section string. - Thats the only difference between the the sell and buy functionsw
    rate0index = 1480
    btc_quantity0index = 1489
    rate_str_length = 6
